# Access-Form-Project
AccessForm is a web-based survey builder designed with accessibility as the highest priority. Unlike common survey tools, it ensures that people with disabilities—including those with visual, hearing, motor, or cognitive challenges—can easily create and participate in surveys. The system supports multiple ways to respond, including through the web, voice commands, and SMS, making it widely accessible.
